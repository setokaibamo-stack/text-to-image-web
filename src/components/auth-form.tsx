    ...
    <div className="flex flex-col gap-5 w-full max-w-md mx-auto">
      ...
      <div className="card-glow p-5 sm:p-6">
        <div className="flex items-start gap-3">
          <span
            aria-hidden
            className="inline-flex h-9 w-9 items-center justify-center rounded-[var(--radius-md)] bg-white/[0.06] border border-[var(--border-strong)] shrink-0"
          >
            <GoogleGlyph size={16} />
          </span>
